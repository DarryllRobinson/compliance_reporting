export const fields = [
  { name: "BusinessName", label: "Reporting entity's name" },
  { name: "ABN", label: "Reporting entity's ABN" },
  { name: "ACN", label: "Reporting entity's ACN" },
  {
  ...
  { name: "HeadEntityABN", label: "If applicable, the ABN of the head entity" },
  { name: "HeadEntityACN", label: "If applicable, the ACN of the head entity" },
  {
