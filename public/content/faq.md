## 1. Who is required to report under the new PTRS scheme?
...
## 2. What payments need to be included in a report?
...
## 4. What if a report is submitted using the old CSV template?
...
## 7. Are credit card payments required to be reported?
